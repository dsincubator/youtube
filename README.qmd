...
*On GitHub the `dataview` block stays as code (expected) — Dataview is Obsidian-only. The table below is a static snapshot I pasted for GitHub readers; in Obsidian the same query is a live, auto-updating table.*
