---
type: Playbook
title: dsincubator Wiki Index
description: Bundle root concept listing all topics; serves as entry point. Actual
  directory index is topics/index.md (reserved filename per §3.1).
lang: en
tags:
- ds-incubator
generated:
...
# dsincubator Wiki Index

## Overview

The dsincubator Wiki is an OKF v0.2 knowledge bundle that distills 151 video transcripts into 44 interlinked topic pages across 13 categories. It transforms ephemeral meeting captions into a durable, searchable playbook for data-science collaboration at 2 Degrees Investing. This index is the bundle entry point — it lists every topic, explains how the bundle is organized, and links to the underlying sources so readers can verify any claim against the original video.

The bundle follows the OKF v0.2 actor convention (`agent:okf-wiki-builder/1.0` for LLM-synthesized pages, `process:yt-dlp` / `process:convert-transcripts` for raw and converted transcripts, `human:<reviewer>` for verified fields) and verification tiers (§5.3). All topic pages are currently `status: draft` (unverified, advisory) pending human review, which will add `verified: { by: human:<reviewer>, at: <date> }` and flip status to `stable`. Pipeline topics with `type: Attested Computation` include executable `runtime` and `computation_type` metadata.

Sources are preserved one-to-one in `dsincubator/sources/` (one markdown source per transcript, with frozen frontmatter copied byte-identical from the transcript for `tags`, `lang`, `usage_count`, `last_modified`, and `sources[]`). Topics synthesize 2–20 sources each; cross-links connect related topics and link back to verbatim source excerpts. The reserved filename `topics/index.md` is not used per §3.1 — this file (`topics/concepts-overview.md`) serves as the index.
...
- **Bundle structure (OKF v0.2)**: 44 topics across `git/`, `testing/`, `r-packages/`, `pipelines/`, `tidyverse/`, `docker/`, `cloud/`, `shiny/`, `terminal/`, `communication/`, `workflow/`, `data/` plus this index. See [Git Fundamentals](../git/git-fundamentals.md), [Testing Fundamentals](../testing/testing-fundamentals.md), [Creating R Packages](../r-packages/creating-packages.md), [targets Introduction](../pipelines/targets-introduction.md), and [Docker Fundamentals](../docker/docker-fundamentals.md).
- **Provenance and verification (§7, §5.3)**: every claim is anchored to a source file via `sources[]` credibility signals (`author`, `usage_count`, `last_modified`) and `generated.by`. Unverified drafts are advisory; human review promotes to stable.
- **Source layer**: 151 sources in `dsincubator/sources/` — e.g., [source_-9QCNwmpTOE](../../sources/source_-9QCNwmpTOE_test-driven-development.md), [source_S4GyNTwj_sc](../../sources/source_S4GyNTwj_sc_introduction-to-version-control-with-git-initialize-a-git-repository.md), [source_pbc6NX1n01Q](../../sources/source_pbc6NX1n01Q_targets-introduction.md) — each with Summary, Key Concepts, and verbatim Code Snippets.
- **Category map**: Git workflow ([Git Fundamentals](../git/git-fundamentals.md), [Branching and Merging](../git/branching-merging.md), [GitHub Workflow](../git/github-workflow.md), [Gitflow Workflow](../git/gitflow-workflow.md)); Testing ([Testing Fundamentals](../testing/testing-fundamentals.md), [Test-Driven Development](../testing/test-driven-development.md), [Snapshot Tests](../testing/snapshot-tests.md), [Code Coverage](../testing/code-coverage.md)); Pipelines ([Drake Workflows](../pipelines/drake-workflows.md), [Reproducible Workflows](../pipelines/reproducible-workflows.md)); Tidyverse, Docker, Cloud, Shiny, Terminal, Communication, and Data.
- **Navigation**: start here, then follow cross-links to topic pages; each topic lists its contributing videos in a **Sources** table (view counts, dates) and external **References**.
...
| [2Lcba2K8j6M](https://www.youtube.com/watch?v=2Lcba2K8j6M) | [terminal: Setup and navigate](../sources/source_2Lcba2K8j6M_terminal-setup-and-navigate.md) | 16 | 2022-04-19T00:00:00Z |
| [2WBj5Oex_Fc](https://www.youtube.com/watch?v=2WBj5Oex_Fc) | [An overview our our resources at 2dii](../sources/source_2WBj5Oex_Fc_an-overview-our-our-resources-at-2dii.md) | 8 | 2020-01-28T00:00:00Z |
...
| [AFuVF0oWFMY](https://www.youtube.com/watch?v=AFuVF0oWFMY) | [Creating an empty R package up to the best standards](../sources/source_AFuVF0oWFMY_creating-an-empty-r-package-up-to-the-best-standards.md) | 126 | 2024-07-16T00:00:00Z |
...
| [A_Q6nmUhcGA](https://www.youtube.com/watch?v=A_Q6nmUhcGA) | [Reusing your usethis setup across multiple rstudio.cloud projects](../sources/source_A_Q6nmUhcGA_reusing-your-usethis-setup-across-multiple-rstudio-cloud-projects.md) | 31 | 2020-08-11T00:00:00Z |
...
| [BYtt2cXW4qg](https://www.youtube.com/watch?v=BYtt2cXW4qg) | [ds.terminal: Use case - customize and reuse your home](../sources/source_BYtt2cXW4qg_ds-terminal-use-case-customize-and-reuse-your-home.md) | 25 | 2022-05-03T00:00:00Z |
...
| [CLCn5ZkCbrg](https://www.youtube.com/watch?v=CLCn5ZkCbrg) | [Main usethis helpers for GitHub pull requests](../sources/source_CLCn5ZkCbrg_main-usethis-helpers-for-github-pull-requests.md) | 18 | 2019-10-29T00:00:00Z |
...
| [DVmvsZk-9F4](https://www.youtube.com/watch?v=DVmvsZk-9F4) | [terminal: Modify your file system](../sources/source_DVmvsZk-9F4_terminal-modify-your-file-system.md) | 87 | 2022-04-25T00:00:00Z |
...
| [RO-OdWXfpBc](https://www.youtube.com/watch?v=RO-OdWXfpBc) | [Docker: managing containers](../sources/source_RO-OdWXfpBc_docker-managing-containers.md) | 47 | 2021-09-14T00:00:00Z |
...
| [V2oSfukR4mw](https://www.youtube.com/watch?v=V2oSfukR4mw) | [terminal: Start a terminal and navigate your files system](../sources/source_V2oSfukR4mw_terminal-start-a-terminal-and-navigate-your-files-system.md) | 19 | 2022-04-19T00:00:00Z |
...
| [VCHu0uhGo2g](https://www.youtube.com/watch?v=VCHu0uhGo2g) | [pins: Sharing versions of a dataset with pins and Dropbox](../sources/source_VCHu0uhGo2g_pins-sharing-versions-of-a-dataset-with-pins-and-dropbox.md) | 40 | 2022-04-05T00:00:00Z |
| [VRG95a4aBW4](https://www.youtube.com/watch?v=VRG95a4aBW4) | [cloud: More ways to move data](../sources/source_VRG95a4aBW4_cloud-more-ways-to-move-data.md) | 30 | 2022-07-12T00:00:00Z |
...
| [YDsoKUVsJls](https://www.youtube.com/watch?v=YDsoKUVsJls) | [Setup: GitHub, R, RStudio, and Git](../sources/source_YDsoKUVsJls_setup-github-r-rstudio-and-git.md) | 142 | 2019-10-15T00:00:00Z |
...
| [bR0RYYwiDRM](https://www.youtube.com/watch?v=bR0RYYwiDRM) | [The  simplest way to run multiple R sessions in the same IDE](../sources/source_bR0RYYwiDRM_the-simplest-way-to-run-multiple-r-sessions-in-the-same-ide.md) | 615 | 2024-07-19T00:00:00Z |
...
| [iNWBG3x4QVc](https://www.youtube.com/watch?v=iNWBG3x4QVc) | [How to download a file from google drive into your R IDE](../sources/source_iNWBG3x4QVc_how-to-download-a-file-from-google-drive-into-your-r-ide.md) | 251 | 2024-07-19T00:00:00Z |
| [iYlKc0BTjBk](https://www.youtube.com/watch?v=iYlKc0BTjBk) | [terminal: Find things](../sources/source_iYlKc0BTjBk_terminal-find-things.md) | 45 | 2022-05-10T00:00:00Z |
...
| [kS_0s0eS1Xw](https://www.youtube.com/watch?v=kS_0s0eS1Xw) | [pins](../sources/source_kS_0s0eS1Xw_pins.md) | 13 | 2020-04-21T00:00:00Z |
...
| [nL3Qr7bvlg4](https://www.youtube.com/watch?v=nL3Qr7bvlg4) | [dbt usage](../sources/source_nL3Qr7bvlg4_dbt-usage.md) | 32 | 2024-06-23T00:00:00Z |
...
| [sbp5Q8niTho](https://www.youtube.com/watch?v=sbp5Q8niTho) | [Set up a custom user library to install R packages](../sources/source_sbp5Q8niTho_set-up-a-custom-user-library-to-install-r-packages.md) | 2691 | 2022-03-18T00:00:00Z |
...
| [tetgpXHal5s](https://www.youtube.com/watch?v=tetgpXHal5s) | [Daily Git workflows: "Fork and clone" explained](../sources/source_tetgpXHal5s_daily-git-workflows-fork-and-clone-explained.md) | 23 | 2020-08-04T00:00:00Z |
...
| [vpAW3j5zbX0](https://www.youtube.com/watch?v=vpAW3j5zbX0) | [Daily stand-ups](../sources/source_vpAW3j5zbX0_daily-stand-ups.md) | 23 | 2020-07-21T00:00:00Z |
...
| [yOJZHRGF3Bk](https://www.youtube.com/watch?v=yOJZHRGF3Bk) | [terminal overview](../sources/source_yOJZHRGF3Bk_terminal-overview.md) | 41 | 2022-04-12T00:00:00Z |
...
- CodeRefinery — Introduction to version control with Git (lesson and instructor guide referenced across git sources)
- Hadley Wickham — *Mastering Shiny* testing chapter, *R Packages* testing chapter
- OKF v0.2 specification (§3.1 reserved filenames, §4.1 type field, §5.1 credibility signals, §6 cross-links, §7 actor convention, §8–§9 index/log, §11 conformance)
