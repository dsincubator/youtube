...
description: "Vamos a empezar bien despacio la idea hoy es mostrar lo básico de targets más o menos para entender cómo es la estructura de un proyecto de targets..."
