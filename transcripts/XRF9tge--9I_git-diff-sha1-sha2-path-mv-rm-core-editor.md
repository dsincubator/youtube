...
description: "About git from the terminal we are talking uh through this lesson of cod Refinery that is entitled um introduction to Version Control with Git in the issue..."
