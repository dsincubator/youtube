...
description: "About working with a terminal and if this is the previous last session today we're going to be a multi-user system from the perspective of a regular user..."
