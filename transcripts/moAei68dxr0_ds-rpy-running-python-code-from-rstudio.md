...
description: "This time is with a one session meetup it's not a series with miria about running python code why that might be important for for us or for..."
